...
class ResultByDateTable extends StatefulWidget {
  // Function _setTagState;

  ResultByDateTable({super.key});

  @override
  State<ResultByDateTable> createState() => _ResultByDateTableState();
}

class _ResultByDateTableState extends State<ResultByDateTable> {
                ...
                child: dataResponse.isEmpty
                    ...
                    : PaginatedDataTable(
                        ...
                        columns: const [
                          ...
                          DataColumn(label: Text('TestCase')),
  ...
  DataRow? getRow(int index) {
    return DataRow(cells: [
      ...
      DataCell(ConstrainedBox(
          ...
          child: Text(dataResponse[index].name + dataResponse[index].id.toString(),
              overflow: TextOverflow.ellipsis, maxLines: 2))),
